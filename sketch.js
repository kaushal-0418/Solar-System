...
function preload() {
    sunImg = loadImage("s.jpg");
    mercuryImg = loadImage("m.jpg");
    venusImg = loadImage("ve.jpg");
    earthImg = loadImage("e.jpg");
    marsImg = loadImage("ma.jpg");
    jupeterImg = loadImage("j.jpg");
    saturnImg = loadImage("st1.jpg");
    uranusImg = loadImage("u.jpg");
    neptuneImg = loadImage("n.jpg");
